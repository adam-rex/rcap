-- Extend contacts page RPC payload to include contact_type + sector.
...
comment on function public.workspace_contacts_page (text, int, int, text, text) is
  'Paged contact list with optional role + organisation type filters and search on name, contact type, sector, role, notes, geography, and organisation name.';
