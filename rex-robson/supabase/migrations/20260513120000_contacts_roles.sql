...
-- (e.g. spv_investor, borrower). Separate axis from contacts.contact_type. No backfill.
...
comment on column public.contacts.roles is
  'Roles this contact plays in Robson deals (multi-select). Initial slugs: spv_investor, borrower. Independent of contact_type.';
